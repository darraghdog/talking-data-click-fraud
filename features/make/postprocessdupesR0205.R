...
table(tstdf[ct>0]$shft, tstdf[ct>0]$seq)
...
# Write out
fwrite(tstdf[, .(click_id, is_attributed)], paste0(path, "../sub/blend0426___post_process_dupes_UP.csv"), row.names = F)
