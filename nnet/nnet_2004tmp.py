...
# Fasttext layer
ftext_emb = dict(([( col , Embedding(embedding_max[k]+1, embed_size \
        , weights = [embedding_matrix[k]], trainable = False, name = 'emb_'+col) (emb_inputs[col]) ) for col in mapper.keys() if col != 'hour']))
