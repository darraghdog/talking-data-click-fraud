...
params = {
    ...
    'verbose': 1,
    'metric':'auc',
    'scale_pos_weight':300.0 # because training data is extremely unbalanced 
}
...
if not validation:
    ...
    print("writing...")
    sub.to_csv(path + '../sub/sub_lgb3004A.csv.gz',index=False, compression = 'gzip')
    print("done...")
    print(sub.info())
else:
    max_ip = 126413
    ...
    predsdf.to_csv(path + '../sub/sub_lgb3004Aval.csv.gz',index=False, compression = 'gzip')
