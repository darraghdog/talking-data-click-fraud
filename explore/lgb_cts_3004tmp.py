...
if not validation:
    ...
    print("writing...")
    sub.to_csv(path + '../sub/sub_lgb3004_bmean.csv.gz',index=False, compression = 'gzip')
    print("done...")
    print(sub.info())
else:
    max_ip = 126413
    ...
    predsdf.to_csv(path + '../sub/sub_lgb3004val_bmean.csv.gz',index=False, compression = 'gzip')
