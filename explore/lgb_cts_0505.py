...
if not validation:
    ...
    print("writing...")
    sub.to_csv(path + '../sub/sub_lgb0505_nodev1.csv.gz',index=False, compression = 'gzip')
    print("done...")
    print(sub.info())
else:
    max_ip = 126413
    ...
    predsdf.to_csv(path + '../sub/sub_0505_nodev1val.csv.gz',index=False, compression = 'gzip')
