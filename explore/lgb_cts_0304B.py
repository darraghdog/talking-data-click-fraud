...
train_df = pd.concat([train_df, feattrn, feattrnnext, feattrnprev, feattrnld5], axis=1)
test_df  = pd.concat([test_df , feattst, feattstnext, feattstprev, feattstld5], axis=1)
...
lead_cols += [col for col in train_df.columns if 'click_sec_' in col]
