...
test_df  = test_df[test_df['device']==1]
...
if not validation:
    ...
    print("writing...")
    sub.to_csv(path + '../sub/sub_lgb0505_onlydev1.csv.gz',index=False, compression = 'gzip')
    print("done...")
    print(sub.info())
else:
    max_ip = 126413
    ...
    predsdf.to_csv(path + '../sub/sub_0505_onlydev1val.csv.gz',index=False, compression = 'gzip')
