...
print('load train...')
train_df = pd.read_csv(path+"trainvalsmall.csv", nrows=trn_load, dtype=dtypes, usecols=['ip','app','device','os', 'channel', 'click_time', 'is_attributed'])
print('load test...')
...
print("writing...")
sub.to_csv(path + '../sub/sub_lgb1703_val.csv',index=False)
print("done...")
print(sub.info())
