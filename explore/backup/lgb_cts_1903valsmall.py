...
featent1  = pd.read_csv(path+'../features/entropy_ip_hr.gz', compression = 'gzip')
featent2  = pd.read_csv(path+'../features/entropy_ip_devos.gz', compression = 'gzip')
...
print('add entropy')
train_df = train_df.merge(featent1, on=['ip'], how='left')
train_df = train_df.merge(featent2, on=['ip'], how='left')
train_df.head()
del featent1, featent2
...
print("writing...")
sub.to_csv(path + '../sub/sub_lgb1803_val.csv',index=False)
print("done...")
print(sub.info())
...
#1                     os  243
#2                channel  199
#3     click_sec_lead_chl  127
#4   ip_visit_min_entropy   96
#5                   hour   95
#6                    app   81
#7       ip_devos_entropy   67
#8                    qty   66
#9    ip_visit_hr_entropy   44
#10     click_sec_lead_os   37
#11                device   36
#12       ip_app_os_count   34
#13                    ip   29
#14         same_next_app   27
#15     click_sec_lsum_os   14
#16    click_sec_lsum_chl   12
#17      click_sec_lag_os    8
#18          ip_app_count    7
#19     click_sec_lag_chl    7
#20         same_next_chl    5
#21                   day    0