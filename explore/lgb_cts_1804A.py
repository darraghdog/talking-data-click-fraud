...
feattrngib = pd.read_csv(path+'../features/leads_ratios_trn%s.gz'%(add_), compression = 'gzip')
feattstgib = pd.read_csv(path+'../features/leads_ratios_tst%s.gz'%(add_), compression = 'gzip')
...
feattrn = pd.concat([feattrn, feattrnspl, feattrnsp1, feattrncum, feattrnchl, feattrnos, feattrnld2, feattrngib], axis=1)
feattst = pd.concat([feattst, feattstspl, feattstsp1, feattstcum, feattstchl, feattstos, feattstld2, feattstgib], axis=1)
del feattrnspl, feattrnsp1, feattrncum, feattrnchl, feattrnos, feattrnld2, feattrngib
del feattstspl, feattstsp1, feattstcum, feattstchl, feattstos, feattstld2, feattstgib
gc.collect()
