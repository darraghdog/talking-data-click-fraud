...
print('load train...')
train_df = pd.read_csv(path+"trainvalsmall.csv", dtype=dtypes, nrows=trn_load,  usecols=['ip','app','device','os', 'channel', 'click_time', 'is_attributed'])
print('load test...')
test_df = pd.read_csv(path+"testvalsmall.csv", dtype=dtypes, nrows=trn_load, usecols=['ip','app','device','os', 'channel', 'click_time', 'click_id'])

print('load features...')
feattrnchl = pd.read_csv(path+'../features/lead_lag_trn_ip_device_os_channelvalsmall.gz', compression = 'gzip', nrows=trn_load)
feattstchl = pd.read_csv(path+'../features/lead_lag_tst_ip_device_os_channelvalsmall.gz', compression = 'gzip', nrows=trn_load)
feattrnos  = pd.read_csv(path+'../features/lead_lag_trn_ip_device_osvalsmall.gz', compression = 'gzip', nrows=trn_load)
feattstos  = pd.read_csv(path+'../features/lead_lag_tst_ip_device_osvalsmall.gz', compression = 'gzip', nrows=trn_load)
...
feattrnnext  = pd.read_csv(path+'../features/next_trn_ip_device_osvalsmall.gz', compression = 'gzip', nrows=trn_load).astype(np.int8)
feattstnext  = pd.read_csv(path+'../features/next_tst_ip_device_osvalsmall.gz', compression = 'gzip', nrows=trn_load).astype(np.int8)
